...
import static com.grigoriliev.jsampler.JSPrefs.MANUAL_SERVER_SELECT_ON_STARTUP;
...
import com.grigoriliev.jsampler.event.ListSelectionEvent;
import com.grigoriliev.jsampler.event.ListSelectionListener;
...
public abstract class AndroidMainFrame<CP extends AndroidChannelsPane> implements JSMainFrame<CP> {
	private final PropertyChangeSupport propertyChangeSupport = new PropertyChangeSupport(this);
	protected final Vector<CP> chnPaneList = new Vector<CP>();
	private boolean autoUpdateChannelListUI = true;
	
	public AndroidMainFrame() {
	...
	/** Invoked from the main activity's <code>onCreate()</code> method. */
	public abstract void onCreate();
	
	/** Returns the main frame's root view. */
	public abstract View getView();
	
	public abstract void uninstall();
	
	public boolean
	onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) { return false; }
	...
	@Override
	public Server
	getServer() { throw new UnsupportedOperationException(); }
	
	@Override
	public Server
	getServer(boolean manualSelect) { throw new UnsupportedOperationException(); }
}
