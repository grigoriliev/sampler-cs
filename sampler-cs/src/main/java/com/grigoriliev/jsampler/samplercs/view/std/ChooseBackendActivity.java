...
package com.grigoriliev.jsampler.samplercs.view.std;
...
import com.grigoriliev.jsampler.samplercs.view.ServerListAdapter;
...
import static com.grigoriliev.jsampler.JSPrefs.SERVER_INDEX;
...
public class ChooseBackendActivity extends Activity {
	...
	connect() {
		...
		Intent i = getIntent();
		i.putExtra("com.grigoriliev.jsampler.SomeSerializableObject", server);
